...
import { o as originPathnameSymbol, A as AstroError, F as ForbiddenRewrite } from './chunks/astro/server_ON6jawE_.mjs';
import 'clsx';
import 'cookie';
import 'html-escaper';

const onRequest$1 = async ({ cookies, locals }, next) => {
